...
void MyInit(void) {
    ...
    // Id = [Idr,Idg,Idb]
    GLfloat light_diffuse[] = { 0.070, 0.070, 0.929, 1.0 };
    GLfloat light_diffuse_1[] = { 0.929, 0.082, 0.07, 0.0 };

    // Is = [Isr,Isg,Isb]
    GLfloat light_specular[] = { 0.070, 0.070, 0.929, 1.0 };
    GLfloat light_specular_1[] = { 0.929, 0.082, 0.07, 1.0 };
...
int main() {
    ...
    glutCreateWindow("Lux mentis Lux orbis");
